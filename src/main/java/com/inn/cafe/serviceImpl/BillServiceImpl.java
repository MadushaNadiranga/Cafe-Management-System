        ...
        switch (type) {
            case "Header":
                Font headerFont = FontFactory.getFont(
                        FontFactory.HELVETICA_BOLDOBLIQUE, 18, BaseColor.BLACK);
    ...
    public ResponseEntity<String> deleteBill(Integer id) {
        try {
            ...
            if (!optional.isEmpty()){
                ...
                return CafeUtils.getResponseEntity("Bll Deleted Successfully.",HttpStatus.OK);


            }
            return CafeUtils.getResponseEntity("Bll id does not exist.",HttpStatus.OK);
        }catch (Exception ex){
            ex.printStackTrace();
        }
